        ...
        <div className="bg-white shadow rounded-lg p-8">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-8">
            <p className="text-sm text-blue-700">
              Con el objetivo de brindar información a los directivos docentes que le permita identificar los retos de la Institución Educativa, el Programa Rectores Líderes Transformadores y Coordinadores Líderes Transformadores ha diseñado una encuesta de percepción sobre la comunicación, la convivencia y las prácticas pedagógicas que contribuyen al desarrollo de un liderazgo orientado a propiciar un mejor ambiente escolar en la Institución Educativa.
            </p>
